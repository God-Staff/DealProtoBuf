...
void makesetfiles ()
{
	...
	ff.add_config ()->set_type (qiuwanli::Config_Type::Config_Type_DownFilePath);
	//ff.add_config ()->Clear ();
	ff.add_config ()->set_valuestring ("C:\\Users\\God-S\\Favorites");
	ff.add_config ()->set_type (qiuwanli::Config_Type::Config_Type_FilePath);
	//ff.add_config ()->Clear ();
	ff.add_config ()->set_valuestring ("2");
	ff.add_config ()->set_type (qiuwanli::Config_Type::Config_Type_ThreadNumDown);
	//ff.add_config ()->Clear ();
	ff.add_config ()->set_valuestring ("3");
	ff.add_config ()->set_type (qiuwanli::Config_Type::Config_Type_ThreadNumUp);
	//ff.add_config ()->Clear ();
	ff.add_config ()->set_valuestring ("230");
	ff.add_config ()->set_type (qiuwanli::Config_Type::Config_Type_FileDownSpeed);
	//ff.add_config ()->Clear ();
	ff.add_config ()->set_valuestring ("100");
	ff.add_config ()->set_type (qiuwanli::Config_Type::Config_Type_FileUpSpeed);
	//ff.add_config ()->Clear ();	
