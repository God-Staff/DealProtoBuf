...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Config, stringtype_),
  ~0u,  // no _has_bits_
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n\014config.proto\022\010qiuwanli\"1\n\006Config\022\023\n\013va"
      "lueString\030\001 \001(\t\022\022\n\nstringtype\030\002 \001(\r\".\n\nC"
      "onfigFile\022 \n\006config\030\001 \003(\0132\020.qiuwanli.Con"
      "figb\006proto3"
  };
...
const int Config::kStringtypeFieldNumber;
...
void Config::SerializeWithCachedSizes(
  ...
  if (this->stringtype() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->stringtype(), output);
  }
...
::google::protobuf::uint8* Config::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 stringtype = 2;
  if (this->stringtype() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->stringtype(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:qiuwanli.Config)
  ...
  if (from.stringtype() != 0) {
    set_stringtype(from.stringtype());
  }
}
...
void Config::InternalSwap(Config* other) {
  ...
  std::swap(stringtype_, other->stringtype_);
...
// uint32 stringtype = 2;
void Config::clear_stringtype() {
  stringtype_ = 0u;
}
::google::protobuf::uint32 Config::stringtype() const {
  // @@protoc_insertion_point(field_get:qiuwanli.Config.stringtype)
  return stringtype_;
}
void Config::set_stringtype(::google::protobuf::uint32 value) {
  
  stringtype_ = value;
  // @@protoc_insertion_point(field_set:qiuwanli.Config.stringtype)
}
