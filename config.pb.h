...
class Config : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:qiuwanli.Config) */ {
 public:
  ...
  ::google::protobuf::uint32 stringtype() const;
  void set_stringtype(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 stringtype_;
...
// uint32 stringtype = 2;
inline void Config::clear_stringtype() {
  stringtype_ = 0u;
}
inline ::google::protobuf::uint32 Config::stringtype() const {
  // @@protoc_insertion_point(field_get:qiuwanli.Config.stringtype)
  return stringtype_;
}
inline void Config::set_stringtype(::google::protobuf::uint32 value) {
